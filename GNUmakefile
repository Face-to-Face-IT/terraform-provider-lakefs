...
install: build
	mkdir -p ~/.terraform.d/plugins/registry.terraform.io/Face-to-Face-IT/lakefs/0.1.0/linux_amd64
	cp terraform-provider-lakefs ~/.terraform.d/plugins/registry.terraform.io/Face-to-Face-IT/lakefs/0.1.0/linux_amd64/
...
clean:
	...
	rm -rf ~/.terraform.d/plugins/registry.terraform.io/Face-to-Face-IT/lakefs/
